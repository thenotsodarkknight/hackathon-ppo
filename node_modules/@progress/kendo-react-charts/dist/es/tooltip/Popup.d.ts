...
export declare class TooltipPopup extends React.Component<TooltipPopupProps, {}> {
    static contextTypes: {
        observersStore: PropTypes.Requireable<object>;
        childrenObserver: PropTypes.Requireable<object>;
    };
    ...
    onChartMouseLeave: (e: DomEvent<React.MouseEvent<HTMLDivElement, MouseEvent>>) => boolean;
