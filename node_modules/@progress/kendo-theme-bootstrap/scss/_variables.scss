...
$form-hint-font-size: 11px !default;
...
$stepper-connector-calc-offset: calc(( #{$stepper-indicator-height} / 2) + #{$stepper-progressbar-size / 2} + #{$stepper-indicator-focus-offset}) !default;
...
$splitter-text: $button-text !default;

$splitter-hovered-bg: darken($button-hovered-bg, 5) !default;
$splitter-hovered-text: $button-hovered-text !default;
...
$scheduler-nonwork-bg: mix( $component-text, $component-bg, ($color-level-step / 2) ) !default;
