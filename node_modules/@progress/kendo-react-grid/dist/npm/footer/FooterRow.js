...
var FooterRow = /** @class */ (function (_super) {
    ...
    function FooterRow() {
        ...
        _this.renderCell = function (column, index) {
            ...
            return (column.footerCell && React.createElement(column.footerCell, __assign({}, cellProps, { key: index }))) || (React.createElement("td", __assign({ key: index }, tdProps)));
        };
        return _this;
    }
    ...
    FooterRow.prototype.render = function () {
        return React.createElement("tr", null, utils_1.footerColumns(this.props.columns).map(this.renderCell));
    };
    return FooterRow;
}(React.Component));
