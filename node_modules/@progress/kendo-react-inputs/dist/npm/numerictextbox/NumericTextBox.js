...
exports.NumericTextBox = React.forwardRef(function (props, target) {
    ...
    return props.label
        ? (React.createElement(kendo_react_common_1.FloatingLabel, { id: inputId, value: looseValue === null ? '' : looseValue, valid: isValid, placeholder: props.placeholder, label: props.label, children: numerictextbox, style: { width: props.width }, dir: props.dir }))
        : numerictextbox;
});
