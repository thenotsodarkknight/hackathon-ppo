...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        ...
        visited = _a.visited, touched = _a.touched, modified = _a.modified, validityStyles = _a.validityStyles, style = _a.style, props = __rest(_a, ["className", "label", "id", "validationMessage", "defaultValue", "valid", "visited", "touched", "modified", "validityStyles", "style"]);
        ...
        return label ?
            (React.createElement(kendo_react_common_1.FloatingLabel, { label: label, children: textbox, value: String(this.value), placeholder: props.placeholder, id: inputId, valid: isValid, style: style, dir: props.dir }))
            : textbox;
    };
    /**
     * @hidden
