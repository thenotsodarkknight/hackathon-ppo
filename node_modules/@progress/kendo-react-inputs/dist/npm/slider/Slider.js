...
var Slider = /** @class */ (function (_super) {
    ...
    Slider.prototype.render = function () {
        ...
        var sliderItemsStyle = this.props.vertical
            ...
            : {};
        return (React.createElement("div", { "aria-valuemin": this.props.min, "aria-valuemax": this.props.max, "aria-valuenow": this.state.value, "aria-disabled": this.props.disabled ? 'true' : undefined, role: "slider", style: this.props.style, tabIndex: kendo_react_common_1.getTabIndex(this.props.tabIndex, this.props.disabled, undefined), onFocus: this.onFocus, onBlur: this.onBlur, onKeyDown: this.onKeyDown, className: kendo_react_common_1.classNames('k-slider k-widget k-state-default', this.props.className, {
